<nav class="bottom-nav">
 ...
 <a class="<?php echo e(request()->routeIs('schedule')?'active':''); ?>" href="<?php echo e(route('schedule')); ?>">
  <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M7 3v4M17 3v4M4 8h16M5 5h14v16H5z"/></svg>Jadwal
 </a>
 <a class="<?php echo e(request()->routeIs('favorite')?'active':''); ?>" href="<?php echo e(route('favorite')); ?>">
 ...
 <a class="<?php echo e(request()->routeIs('settings')||request()->routeIs('profile*')||request()->routeIs('help')?'active':''); ?>" href="<?php echo e(route('settings')); ?>">
...
<?php /**PATH C:\laragon\www\SMS 4 PROJECT\HAMPIR BERESS\10 fINAL FIX\Kawan Jalan web\resources\views/components/bottom-nav.blade.php ENDPATH**/ ?>