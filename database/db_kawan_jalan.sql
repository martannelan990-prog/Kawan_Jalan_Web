...
INSERT INTO `cities` (`id`, `name`, `slug`, `image`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `destinations` (`id`, `city_id`, `name`, `slug`, `image`, `description`, `ticket_price`, `open_hour`, `location`, `is_popular`, `is_recommended`, `activity_count`, `created_at`, `updated_at`) VALUES
(1, 1, 'Curug Cikuluwung', 'curug-cikuluwung', 'assets/kawan/destinations/curug-cikuluwung.jpg', 'Air terjun dengan tebing bebatuan dan suasana alam yang segar.', 25000, '08.00-16.00 WIB', 'Cibitung Wetan, Pamijahan, Bogor', 1, 1, 1, '2026-05-15 01:04:33', '2026-05-15 01:04:33'),
(2, 1, 'Curug Ciberang', 'curug-ciberang', 'assets/kawan/destinations/curug-ciberang.webp', 'Wisata alam sungai yang cocok untuk petualangan dan aktivitas seru bersama rombongan.', 40000, '07.00-18.00 WIB', 'Bogor', 1, 1, 1, '2026-05-15 01:04:33', '2026-05-15 01:04:33'),
...
INSERT INTO `notifications_app` (`id`, `user_id`, `title`, `message`, `type`, `is_read`, `created_at`, `updated_at`) VALUES
(1, 2, 'Booking Berhasil!', 'Booking Anda untuk Curug Cikuluwung telah dikonfirmasi. Guide akan menghubungi Anda segera.', 'success', 0, '2026-05-15 01:04:33', '2026-05-15 01:04:33'),
...
INSERT INTO `orders` (`id`, `user_id`, `destination_id`, `guide_name`, `guide_phone`, `ticket_price`, `guide_fee`, `admin_fee`, `ticket_quantity`, `include_guide`, `total`, `status`, `payment_method`, `payment_deadline`, `paid_at`, `ticket_code`, `group_barcode`, `created_at`, `updated_at`) VALUES
(1, 2, 1, 'Pemandu Kawan Jalan', '0812-3456-7890', 25000, 250000, 10000, 1, 1, 285000, 'paid', 'QRIS', '2026-05-15 01:19:33', '2026-05-15 01:04:33', 'TM3288422', 'GRP-TM3288422', '2026-05-15 01:04:33', '2026-05-15 01:04:33');
...
INSERT INTO `reports` (`id`, `user_id`, `guide_name`, `guide_phone`, `group_link`, `destination_name`, `description`, `status`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `users` (`id`, `name`, `email`, `phone`, `email_verified_at`, `password`, `role`, `status`, `country`, `city`, `address`, `remember_token`, `created_at`, `updated_at`) VALUES
...
--
ALTER TABLE `favorites`
  ADD CONSTRAINT `favorites_destination_id_foreign` FOREIGN KEY (`destination_id`) REFERENCES `destinations` (`id`) ON DELETE CASCADE,
