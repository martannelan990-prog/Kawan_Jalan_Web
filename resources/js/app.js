...
window.startCountdown = function (el, deadline) {
    function tick() {
...
(function () {
    ...
    document.addEventListener('click', function (event) {
        ...
        if (passwordButton) {
            const target = document.querySelector(passwordButton.dataset.passwordToggle);
            if (target) {
        ...
        if (toggle) {
            ...
            const text = toggle.closest('.settings-line')?.querySelector('[data-toggle-label]');
